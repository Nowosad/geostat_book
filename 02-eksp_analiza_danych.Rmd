...
Zazwyczaj przed przystąpieniem do analiz geostatystycznych koniecznie jest wykonanie eksploracyjnej analizy danych nieprzestrzennych. 
...
Oczywiście, każdy z elementów można obejrzeć indywidualnie, poprzez połączenie nazwy obiekty, znaku `@`, oraz nazwy elementu.
Przykładowo `punkty@data` pozwala na obejrzenie tabeli atrybutów zbioru punktowego.
