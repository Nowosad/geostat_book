...
Można wyróżnić dwie główne grupy modeli przestrzennych - modele deterministyczne (\@ref(modele-deterministyczne) oraz modele statystyczne (\@ref(modele-statystyczne).
...
- Metoda diagramów Voronoi'a (ang.  *Voronoi diagram*) (sekcja \@ref(voronoi))
...
Metoda diagramów Woronoja polega na stworzeniu nieregularnych poligonów na podstawie analizowanych punktów, a następnie wpisaniu w każdy poligon wartości odpowiadającego punktu. 
