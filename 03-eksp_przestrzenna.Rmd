...
- Próba - zbiór obserwacji, dla których mamy informacje.
...
Przyjrzenie się wartościom analizowanej cechy można wykonać z użyciem funkcji `spplot()`. 
...
Dodatkowo, używając argumentu `identify = TRUE` można interaktywnie określić numer punktu (numer wiersza w tabeli atrybutów).
Działanie tej funkcji polega na wybraniu punktów za pomocą lewego przycisk myszy, a po wybraniu serii punktów klawisza Esc.
