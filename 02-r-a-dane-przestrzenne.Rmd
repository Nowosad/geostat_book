...
W ten sposób możliwe jest określenie gdzie są one położone, a także jak wykonywane są na nich operacje przestrzenne.
...
- Reprezentację **proj4string** - określa ona własności układu współrzędnych
...
...lub też za pomocą kodu EPSG jako:
