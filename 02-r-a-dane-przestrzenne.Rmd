...
Pakiety **sf** czy **stars** wykorzystują biblioteki [GDAL/OGR](http://www.gdal.org/) w R do wczytywania i zapisywania danych przestrzennych. 
...
W ten sposób możliwe jest określenie gdzie są one położone, a także pozwala to na wykonywanie na nich wielu operacji przestrzennych.
...
W tych układach realna wielkość oczka siatki (jego powierzchnia) jest zmienna, a jednostka mapy jest abstrakcyjna.
