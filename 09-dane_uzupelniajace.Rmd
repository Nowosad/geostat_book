...
library(gridExtra)
p1 <- spplot(uk1, "var1.pred", main = "Predykcja KU")
p2 <- spplot(uk1, "var1.var", main = "Wariancja predykcji KU")
grid.arrange(p1, p2, ncol = 1)
```
...
library(gridExtra)
p1 <- spplot(uk2, "var1.pred", main = "Predykcja KU")
p2 <- spplot(uk2, "var1.var", main = "Wariancja predykcji KU")
grid.arrange(p1, p2, ncol = 1)
```
