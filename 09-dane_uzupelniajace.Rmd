...
## Prosty kriging ze zmiennymi średnimi lokalnymi (LVM) {#SKlm}
...
1. Zastosuj prosty kriging ze zmiennymi średnimi lokalnymi do stworzenia estymacji zmiennej `ndvi` używając jej relacji ze zmienną `savi`.
