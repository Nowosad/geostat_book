...
plot(siatka["clc"])
ip1 <- spplot(siatka["clc"], main = "clc", colorkey = list(space = "bottom"))
ip2 <- spplot(siatka["srtm"], main = "srtm", colorkey = list(space = "bottom"))
ip3 <- spplot(siatka["ndvi"], main = "ndvi", colorkey = list(space = "bottom"))
