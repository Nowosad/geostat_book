...
```{r 13-symulacje-5, fig.cap = "Model semiwariogramu zmiennej temp_log."}
...
```{r 13-symulacje-6, fig.cap = "Symulacja warunkowa zmiennej temp_log."}
...
```{r 13-symulacje-7, fig.cap = "Symulacja warunkowa zmiennej temp_log po przeskalowaniu do oryginalnych wartości."}
...
```{r 13-symulacje-10, fig.cap = "Model semiwariogramu empirycznego binarnej zmiennej temp_ind stworzony na potrzeby symulacji."}
