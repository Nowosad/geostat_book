...
htmlFile <- readLines(paste("source/", htmlFileNames[1], sep=""))
htmlFile <- sub("<!-- BEGIN page-nav -->", navFirst, htmlFile, fixed = TRUE)
writeLines(htmlFile, paste("source/", htmlFileNames[1], sep=""))
...
# Insert page navigation into html file
htmlFile <- readLines(paste("source/", htmlFileNames[length(htmlFileNames)], sep=""))
htmlFile <- sub("<!-- BEGIN page-nav -->", navLast, htmlFile, fixed = TRUE)
writeLines(htmlFile, paste("source/", htmlFileNames[length(htmlFileNames)], sep=""))
