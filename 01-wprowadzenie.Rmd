...
plot(punkty["temp"], reset = FALSE, main = NA)
...
sk = krige(temp~1, 
            ...
            beta = 16, 
            debug.level = 0)
plot(sk["var1.pred"], main = "Estymacja",
     col = paleta)
```
...
```{r 01-wprowadzenie-8, echo=FALSE, message=FALSE, fig.cap = "Przykłady symulowanych wartości badanej zmiennej dla całego obszaru."}
sym_ok = krige(temp~1, 
                locations = punkty,
                newdata = siatka, 
                model = fitted_sph,
