...
R zawiera wiele funkcji pozwalających na przetwarzanie, wizualizację i analizowanie danych przestrzennych. Zawarte są one w szeregu pakietów (zbiorów funkcji), między innymi są to:
...
Więcej szczegółów na ten temat można znaleźć pod adresem https://cran.r-project.org/web/views/Spatial.html.
