...
```{r plotsy2ik2, echo=FALSE, fig.height=8, message=FALSE}
library(gridExtra)
p1p = p1_base + geom_stars(data = ik["prog1"]) + scale_fill_viridis_d()
p2p = p1_base + geom_stars(data = ik["prog2"]) + scale_fill_viridis_d()
