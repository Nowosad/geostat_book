...
**Skrypt jest obecnie aktualizowany do celów trzeciego wydania.**
...
Dodatkowo, użyte zostały poniższe pakiety R [@R-caret;@R-dismo;@R-fields;@R-ggplot2;@R-gridExtra;@R-gstat;@R-mapview;@R-pgirmess;@R-rcartocolor;@R-rsample;@R-sf;@R-stars].

```{r pakietsy}
pakiety = c(
  "caret", "dismo", "fields", "ggplot2", "gridExtra",
  "gstat", "mapview", "pgirmess", "rcartocolor", 
  "rsample", "sf", "stars"
)
```
...
devtools::install_github("nowosad/geostatbook@3")
```
