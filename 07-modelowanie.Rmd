...
data("siatka")
set.seed(1712)
punkty2 = spsample(siatka, type = "stratified", n = 50)
...
```{r, echo=FALSE}
model_exp <- fit.variogram(vario2, vgm(psill = 0.08, model = "Exp", range = 2000))
...
```{r, echo=FALSE}
model_gau <- vgm(psill = 0.08, model = "Gau", range = 750)
...
```{r, echo=FALSE}
model_pow <- fit.variogram(vario2, vgm(psill = 0.03, model = "Pow", range = 0.7))
