...
k_sph <- krige(values~1, 
               ...
               model = model_sph,
               debug.level = 0)
spplot(k_sph[1], at = seq(0, 1, by = 0.05))
```
...
k_exp <- krige(values~1, 
               ...
               model = model_exp,
               debug.level = 0)
spplot(k_exp[1], at = seq(0, 1, by = 0.05))
```
...
k_gau <- krige(values~1, 
               ...
               model = model_gau,
               debug.level = 0)
spplot(k_gau[1], at = seq(0, 1, by = 0.05))
```
...
k_pow <- krige(values~1, 
               ...
               model = model_pow,
               debug.level = 0)
spplot(k_pow[1], at = seq(0, 1, by = 0.05))
```
...
```{r}
library(gridExtra)
grid.arrange(spplot(k_sph[1], main = "Model sferyczny", at = seq(0, 1, by = 0.05)), 
             spplot(k_exp[1], main = "Model wykładniczny", at = seq(0, 1, by = 0.05)), 
             spplot(k_gau[1], main = "Model gaussowski", at = seq(0, 1, by = 0.05)), 
             spplot(k_pow[1], main = "Model potęgowy", at = seq(0, 1, by = 0.05)))
```
