...
```{r, echo=FALSE}
model_sph <- fit.variogram(vario, vgm(psill = 10, model = "Sph", range = 3000))
...
```{r, echo=FALSE}
model_exp <- fit.variogram(vario, vgm(psill = 10, model = "Exp", range = 3000))
...
```{r, echo=FALSE}
model_gau <- fit.variogram(vario, vgm(psill = 13, model = "Gau", range = 3000))
...
```{r, echo=FALSE}
model_pow <- fit.variogram(vario, vgm(psill = 0.03, model = "Pow", range = 0.7))
