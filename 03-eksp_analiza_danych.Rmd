...
Wykres słupkowy (ang. *bar plot*) przedstawia liczebność kolejnych grup.

```{r 03-eksp-analiza-danych-13, fig.cap = "Wykres słupkowy zmiennej clc z obiektu punkty."}
...
```{r 03-eksp-analiza-danych-14, echo=FALSE, eval=FALSE}
