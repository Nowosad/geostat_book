...
Redukcja skośności może być przeprowadzona z użyciem:
...
### Logarytmizacja i funkcja wykładnicza

Jedną grupą technik służących redukcji skośności jest logarytmizacja i funkcja wykładnicza.
...
Możliwe jest też wykonanie odwrotnej operacji - redukcję skośności używając funkcji wykładniczej, a następnie przywrócenie oryginalnej jednostki używając logarytmizacji.

### Pierwiastkowanie i potęgowanie

Druga grupą technik służących redukcji skośności jest pierwiastkowanie i potęgowanie.
...
Podobnie jak w poprzednim przypadku możliwe jest też wykonanie odwrotnej operacji - redukcję skośności używając potęgowania, a następnie przywrócenie oryginalnej jednostki używając pierwiastkowania.
