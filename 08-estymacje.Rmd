...
```{r ploty-trzy-w, echo=FALSE, message=FALSE, fig.asp=0.25, fig.cap="Porównanie wariancji estymacji używając metody krigingu prostego (SK), krigingu zwykłego (OK) i krigingu z trendem (KZT).", fig.width=10}
war = c(sk, ok, kzt)
war = war[c(2, 4, 6)]
