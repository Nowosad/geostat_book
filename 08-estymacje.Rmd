...
- Kriging danych kodowanych (ang. *Indicator kriging*) (sekcja \@ref(modele-statystyczne))
...
Uzyskany wynik jest wpisywany w regularną siatkę.
Możemy go przyciąć do badanego obszaru poprzez wpisanie wartości `NA` w miejscach poza naszym obszarem.

```{r 08-estymacje-14}
kzt$var1.pred[is.na(siatka$X2)] = NA
kzt$var1.var[is.na(siatka$X2)] = NA
```
