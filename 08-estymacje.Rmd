...
library(gridExtra)
p1 <- spplot(sk, "var1.pred", main = "Estymacja SK")
p2 <- spplot(sk, "var1.var", main = "Wariancja estymacji SK")
...
library(gridExtra)
p1 <- spplot(ok, "var1.pred", main = "Estymacja OK")
p2 <- spplot(ok, "var1.var", main = "Wariancja estymacji OK")
grid.arrange(p1, p2, ncol = 1)
```
...
library(gridExtra)
p1 <- spplot(kzt, "var1.pred", main = "Estymacja KZT")
p2 <- spplot(kzt, "var1.var", main = "Wariancja estymacji KZT")
grid.arrange(p1, p2, ncol = 1)
```
...
W rozdziałach \@ref(wykorzystanie-do-estymacji-danych-uzupeniajacych) oraz \@ref(estymacje-wielozmienne) pokazane będą uzyskane wyniki estymacji temperatury powietrza korzystając z innych metod krigingu.
