...
<!-- ```{r} -->
<!-- ggplot(ik@data, aes(var1.pred)) + stat_ecdf() -->
<!-- ``` -->
...
1. Używając obiekt `punkty` stwórz nowe zmienne określające czy zmienna NDVI ma wartość:
    - poniżej 0.1 <!-- barren rock, sand, snow, water -->
    - pomiędzy 0.1 a 0.2 <!-- sparse vegetation such as shrubs and grasslands or senescing crops -->
    - powyżej 0.2 <!--  dense vegetation -->
