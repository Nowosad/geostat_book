...
Na jego podstawie wydziel dwa obiekty - `meuse164` zawierający tylko zmienną `lead` (ołów) dla 164 punktów, oraz `meuse60` zawierający tylko zmienną `copper` (miedź) dla 60 punktów.
...
2. Zbuduj optymalne modele semiwariogramu zmiennej `lead` dla obiektu `meuse164` oraz zmiennej `copper` dla obiektu `meuse60`.
