...
```{r 04-eksp-przestrzenna-3}
plot(st_geometry(granica))
...
```{r 04-eksp-przestrzenna-4, echo=FALSE}
set.seed(225)
...
```{r 04-eksp-przestrzenna-5, echo=FALSE}
set.seed(301)
...
```{r 04-eksp-przestrzenna-6b, error = TRUE, echo=FALSE}
set.seed(125)
...
```{r 04-eksp-przestrzenna-7b, error = TRUE, echo=FALSE}
set.seed(425)
