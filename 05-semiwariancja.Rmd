...
### Geostatystyka | Podstawowe symbole
...
### Przestrzenna kowariancja, korelacja
...
plot(vario_map, threshold = 30, col.regions = topo.colors(n = 40)) # co najmniej 30 par punktów
```
...
```
8. Co przedstawa stworzona mapa semiwariogramu?
